...
|-------------------------|---------------------|-----------------|-------------|
| • .NET Microservices/SaaS<br>• CI/CD Pipelines<br>• DevOps Automation<br>• AI/ML Integration | • Open Source Projects<br>• Community-Driven Tools<br>• Tech Mentorship | • C# & .NET Ecosystem<br>• Java Spring Boot<br>• Microservices Architecture<br>• AI/ML Model Deployment | [🌐 Portfolio](https://bello-webportfolio.netlify.app/) <br> [📧 Email](mailto:bellosoliu12@gmail.com) <br> [💬 LinkedIn](https://linkedin.com/in/sobtech) |
